        ...
        <div className="max-w-screen-xl mx-auto px-4 py-6 mt-12 gap-12 text-gray-600 md:px-8">
          <div className="space-y-5 max-w-4xl mx-auto text-center">
            ...
            <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
             ...
             <div className="w-100">
      <Input type="text" label="Cari Aktifitas Olahraga.." onChange={handleSearch} />
      <Typography
        variant="small"
        color="blue"
        className="mt-2 flex items-center gap-1 font-normal"
      >
        Masukkan aktifitas olahraga yang ingin kamu tahu kalori yang dibakar, contoh: basketball
      </Typography>
    </div>
            </div>
          </div>
