  ...
  const team = [
    {
      ...
      desc: "Ambisius dalam dunia pengembangan perangkat lunak pada bidang web teknologi",
      linkedin: "https://www.linkedin.com/in/huda-putra-santosa/",
      twitter: "javascript:void(0)",
      github: "https://github.com/hudaputrasantosa/",
    },
    {
      avatar:
      ...
      <section className="lg:my-28 my-20 px-4">
        <div className="w-full text-center">
          ...
          <p className="text-gray-600 mt-3">
            mereka merupakan yang mencetus layanan perencanaan pembakaran kalori
            melalui aktivitas kebugaran.
          </p>
        </div>
        <div className="lg:px-28 px-12 mx-auto px-4 md:px-8">
          <div className="mt-12 flex lg:flex-row flex-col gap-16">
            {team.map((item, idx) => (
              <div
                key={idx}
                className="basis-1/2 flex lg:flex-row flex-col lg:text-left text-center items-center gap-8">
                <div className=" flex lg:flex-row flex-col">
                  <img
                    src={item.avatar}
                    className="object-cover object-center shadow-md rounded-xl h-50 w-96"
                    alt=""
                  />
                </div>
                <div className="mt-4 sm:mt-0">
                  ...
                  <p className="text-gray-600 mt-2 text-justify">{item.desc}</p>
